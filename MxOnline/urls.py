...
urlpatterns = [
    ...
    #在线练习url配置
    url(r'^practice/', include('onlinepractice.urls', namespace="practice")),
    ...
    #在线编程相关url
    url(r'^online_code/',include('onlinecode.urls' , namespace='online_code')),
    #在线练习
    url(r'^practice/', include('onlinepractice.urls')),
]
